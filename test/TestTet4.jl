...
common_test_sets(Tet4, [1, 2], [Int32, Int64], [Float32, Float64], [SArray, MArray, Array], [Array, StructArray])

if CUDA.has_cuda()
  common_test_sets(Tet4, [1, 2], [Int32, Int64], [Float32, Float64], [SArray], [StructArray]; cuda=true)
end
