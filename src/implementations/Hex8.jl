...
for type in types_to_generate_interpolants(Hex8(1))
  ...
  """
  """
  @eval function shape_function_hessians(
    e::Hex8,
    ::Type{$(type[3])},
    ξ::A
  ) where A <: AbstractArray{<:Number, 1}
...
# """
# """
# function shape_function_hessians(::Hex8, ::Type{SArray}, ξ::SVector{3, <:Real})
#   ∇∇N_ξ = (@SArray [
#     0.; 
#     0.; 
#     0.; 
...
# # Copy-pasta from above. Can't find a good way to dispatch on this one
# """
# """
# function shape_function_hessians(::Hex8, ::Type{MArray}, ξ::SVector{3, <:Real})
#   ∇∇N_ξ = (@MArray [
#     0.; 
#     0.; 
#     0.; 
